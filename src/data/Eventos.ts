/**
 * O PDF da coordenação é quase ilegível por código;
 * o calendário acadêmico é extraído com ajuda de IA.
 */
interface rawEvent {
	date: string;
...
const rawEvents: rawEvent[] = [
	// --- MARÇO 2026 ---
	{ date: "2026-03-30", event: "INÍCIO DO SEMESTRE LETIVO 2026.1" },
	{
		date: "2026-03-30",
	...
	// --- ABRIL 2026 ---
	{ date: "2026-04-03", event: "FERIADO NACIONAL - Sexta-feira Santa" },
	{ date: "2026-04-04", event: "RECESSO ACADÊMICO – Sábado Santo" },
	{ date: "2026-04-06", untilDate: "2026-04-10", event: "REAJUSTE DE MATRÍCULA on-line para o Semestre Letivo 2026.1" },
	{
		date: "2026-04-07",
		event:
			"Término do período de cadastramento on-line de MONITORES VOLUNTÁRIOS referentes ao Semestre Letivo 2026.1 pelos docentes.",
	},
	{ date: "2026-04-08", event: "MATRÍCULA DE RETARDATÁRIOS on-line para o Semestre Letivo 2026.1 (único dia)." },
	{
		date: "2026-04-10",
		event: "Prazo final para o RESULTADO das solicitações de OUTORGA DE GRAU referente ao Semestre Letivo 2025.2.",
	},
	{ date: "2026-04-16", event: "SOLENIDADE DE OUTORGA DE GRAU referente ao Semestre Letivo 2025.2." },
	{ date: "2026-04-16", untilDate: "2026-04-17", event: "I Feira Literária Infantil - Campus Ibiapaba" },
	{
		date: "2026-04-17",
		untilDate: "2026-04-24",
		event:
	...
	{ date: "2026-04-21", event: "FERIADO NACIONAL - Tiradentes" },
	{
		date: "2026-04-24",
		event:
	...
	// --- MAIO 2026 ---
	{ date: "2026-05-01", event: "FERIADO NACIONAL - Dia do Trabalhador" },
	{
		date: "2026-05-04",
	...
	{ date: "2026-05-06", event: "Dia Nacional da Matemática" },
	{
		date: "2026-05-11",
	...
	{ date: "2026-05-12", untilDate: "2026-05-13", event: "Simpósio de Aquicultura Sustentável - Campus Camocim" },
	{ date: "2026-05-13", event: "FERIADO MUNICIPAL - São Benedito - Nossa Senhora de Fátima" },
	{
		date: "2026-05-18",
	...
	{ date: "2026-05-19", event: "Dia do Físico" },
	{ date: "2026-05-19", untilDate: "2026-05-22", event: "XIV Semana da Enfermagem" },
	{ date: "2026-05-21", event: "Dia da planta medicinal" },
	{
		date: "2026-05-22",
		event:
	...
	{ date: "2026-05-25", untilDate: "2026-05-29", event: "XXII Semana do Curso de Letras" },
	{
		date: "2026-05-28",
	...
	{ date: "2026-06-04", event: "FERIADO NACIONAL - Corpus Christi" },
	{
		date: "2026-06-08",
	...
	{ date: "2026-06-16", untilDate: "2026-06-19", event: "XII Semana de Química" },
	{
		date: "2026-06-22",
	...
	{ date: "2026-06-26", event: "Divulgação do Edital do PROGRAMA DE MONITORIA para o Semestre Letivo 2026.2." },
	{
		date: "2026-06-26",
	...
	{ date: "2026-07-05", event: "FERIADO MUNICIPAL - Aniversário de Sobral" },
	{
		date: "2026-07-06",
	...
	{ date: "2026-07-25", event: "Término da validação da OFERTA do Semestre Letivo 2026.2 pela PROGRAD." },
	{
		date: "2026-07-27",
		untilDate: "2026-08-06",
		event:
	...
	{ date: "2026-07-31", event: "TÉRMINO DO SEMESTRE LETIVO 2026.1" },
	...
	{ date: "2026-08-11", event: "Dia do Estudante" },
	{
		date: "2026-08-15",
		event:
