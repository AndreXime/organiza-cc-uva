		...
		<>
			...
			<div className="space-y-6">
				<div className="flex flex-col gap-4">
					<input
						type="text"
						className="border border-border rounded-full w-full flex items-center px-4 py-2 min-h-[43px] focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm bg-card text-foreground"
					...
					<div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
						<span className="text-sm font-semibold text-heading whitespace-nowrap">Palavras relevantes:</span>
										...
										className={`px-3 py-1.5 rounded-full text-xs font-medium transition-all border
                                            ${
																							isSelected
																								...
																								: "bg-card text-muted border-border hover:border-blue-400 hover:text-blue-500"
																						}
                                        `}
									>
										{keyword}
					...
					<div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
						<span className="text-sm font-semibold text-heading">Período:</span>
						<div className="flex flex-wrap gap-2">
							{TIME_OPTIONS.map((option) => (
                                ...
                                ${
																	timeFilter === option.value
																		...
																		: "bg-card text-muted border-border hover:border-green-400"
																}
                            `}
								>
