		...
		<div className="max-w-7xl mx-auto space-y-12">
			<div>
				...
				<div className="flex gap-4">
					<button
						type="button"
						className="bg-white border-black text-black border-1 p-4 px-3 rounded-full inline-flex gap-2"
					...
					<button
						type="button"
						className="bg-black border-white text-white border-1 p-4 px-3 rounded-full inline-flex gap-2"
