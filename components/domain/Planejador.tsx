		...
		<div className="space-y-8">
			...
			<div className="grid grid-cols-1 gap-8">
				{planejamento.map((semestre, index) => {
					const disciplinasDisponiveis = getDisciplinasDisponiveisParaSelecao(
						semestre,
						index,
					);
					...
					const emEdicao =
						semestreEmEdicao?.ano === semestre.ano &&
						semestreEmEdicao?.semestre === semestre.semestre;
								...
								{emEdicao ? (
									<span className="flex flex-col md:flex-row gap-7 items-center">
										<button
											type="button"
											onClick={() =>
												handleRemoverSemestre(semestre.ano, semestre.semestre)
											}
									...
									<button
										type="button"
										onClick={() =>
											iniciarEdicao(semestre.ano, semestre.semestre)
										}
							...
							{emEdicao && (
								<div className="mt-4">
									<select
										value=""
										onChange={(e) =>
											adicionarDisciplina(Number(e.target.value))
										}
